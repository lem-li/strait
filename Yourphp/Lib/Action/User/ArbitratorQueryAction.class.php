...
class ArbitratorQueryAction extends BaseAction {
...
function xml_to_array($xml){
	...
	function query(){
		...
		$post_data = "account=cf_jmwyh&password=xZDTmj&mobile=".$mobile."&content=".rawurlencode("您的验证码是：".$mobile_code."。请不要把验证码泄露给其他人。");
