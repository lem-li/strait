...
{//类定义开始
    ...
    private function save($file)
    {
        ...
        // 如果是图像文件 检测文件格式
        if( in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png','swf','mp4')) && false === getimagesize($file['tmp_name'])) {
            $this->error = '非法图像文件';
            return false;
        }

		if(in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png','mp4')) && getimagesize($file['tmp_name'])) {
