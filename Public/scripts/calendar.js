...
Calendar.prototype.show = function (dateControl, popuControl) {
	...
	this.panel.style.left = (xy.x - dateControl.clientLeft) +"px";	
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#fff;border:1px solid #989898;width:200px;height:190px;">');
...
__ci.document.writeln('th {font-size:12px;font-weight:normal;background-color:#FFFFFF;height:20px;padding:0px;}');
...
__ci.document.writeln('td {font-size:12px;text-align:center;height:20px;padding:0px;}');
