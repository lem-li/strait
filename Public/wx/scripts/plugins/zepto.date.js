...
(function($) {
    $.fn.date = function(options, Ycallback, Ncallback) {
        ...
        function checkdays(year, month) {
            ...
            //取当年当月中的第一天        
            return new Date(new_date.getTime() - 1e3 * 60 * 60 * 24).getDate();
        }
        function createUL() {
            CreateDateUI();
        ...
        function addTimeStyle() {
            ...
            $("#datePage").css("margin-top", "-177px");
			$("#timemark").css("display","block");
			/*
            $("#yearwrapper").css("bottom", "218px");
            $("#monthwrapper").css("bottom", "218px");
            $("#daywrapper").css("bottom", "218px");
			*/
        }
        //创建 --年-- 列表
