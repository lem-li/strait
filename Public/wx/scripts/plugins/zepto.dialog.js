...
(function($, window, undefined) {
    var win = $(window), doc = $(document), count = 1, isLock = false;
    ...
    Dialog.prototype = {
        ...
        create:function() {
			...
			var divHeader = this.settings.title == null ? "" :'<div class="rDialog-header"><h3>' + this.settings.title + '</h3></div>';
            // HTML模板
            ...
            // 追回到body
            this.dialog = $("<div>").addClass("rDialog").addClass(this.settings.className).css({
         ...
         */
        ok:function() {
            var _this = this, footer = this.dialog.find(".rDialog-footer");
            footer.addClass("rDialog-btngroup");
            $("<a>", {
                href:"javascript:;",
         ...
         */
        size:function() {
            //var content = this.dialog.find(".rDialog-content"), wrap = this.dialog.find(".rDialog-wrap");
			var content = this.dialog.find(".rDialog-content"), wrap = this.dialog.find(".rDialog-wrap");
            this.dialog.css({
         ...
         */
        position:function() {
            var _this = this, winWidth = win.width(), winHeight = win.height(), scrollTop = 0;
            this.dialog.css({
