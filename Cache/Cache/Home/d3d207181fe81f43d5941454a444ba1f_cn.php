...
<div class="wrap" style="overflow:hidden;">
    ...
    <div class="list_r" style="width:960px;">
        <div class="cm">
            <?php echo L(catpos);?><a href="<?php echo URL();?>"> <?php echo L(home_font);?></a> >> <?php if($l=='cn') : ?>网站地图<?php else :?>Site map<?php endif;?>
        </div>
        <div class="r_con">
            <div class="bt" style="padding:0 250px;"><?php echo ($title); ?> </div>
            <br/>
			
            <div style="padding:0 150px;" class="p_content"><?php echo ($content); ?></div>
        </div>
