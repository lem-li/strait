...
<div class="wrap" style="overflow:hidden;">
    ...
    <div class="list_r" style="width:960px;">
        <div class="cm">
        ...
        <div class="r_con">
            <div class="bt" style="padding:0 250px;"><?php echo ($title); ?> </div>
            <br/>
			
			<span style="float:right;padding:0 180px;"><a href="__ROOT__/index.php?m=<?php echo ($module_name); ?>&a=down&id=<?php echo ($id); ?>"><?php if($l=='cn') : ?>文件下载<?php else :?>download<?php endif;?></a></span>
			<br/><br/>
            <div style="padding:0 150px;<?php if($l=='en') : ?>text-indent: 0em;<?php endif;?>" class="p_content"><?php echo ($content); ?></div>
        </div>
        <div class="r_con_b">
            <ul>
                <?php if($predata) : ?>
...
<script language="JavaScript" src="__ROOT__/index.php?m=<?php echo ($module_name); ?>&a=hits&id=<?php echo ($id); ?>"></script>
