        ...
        <div class="content-feed-sidebar">
            ...
            <div class="content-feed notices">
                ...
                <div class="content-feed-con">
                    <ul>
                        <?php  $_result=M("Article")->field("title,url,createtime")->where(" 1  and lang=3 and website=1 AND status=1  AND catid in()")->order("listorder = 0,listorder asc,id desc")->limit("5")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li>
