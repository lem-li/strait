        ...
        <div class="content-feed-sidebar">
            ...
            <div class="content-feed news-hot">
                ...
                <div class="yx-rotaion newpic_list">
                    <ul class="rotaion_list">
                        <?php  $_result=M("Article")->field("title,url,thumb")->where("is_thumb=1 and lang=1 and website=1 AND status=1  AND catid=30")->order("listorder = 0,listorder asc,id desc")->limit("5")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li>
            ...
            <div class="content-feed notices">
                ...
                <div class="content-feed-con">
                    <ul>
                        <?php  $_result=M("Article")->field("title,url,createtime")->where(" 1  and lang=1 and website=1 AND status=1  AND catid=151")->order("listorder = 0,listorder asc,id desc")->limit("5")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li>
            ...
            <div class="row">
                <div class="large-12 medium-12 columns news">
                    ...
                    <div class="content-feed">
                        ...
                        <div class="content-feed-con">
                            <ul>
                                <?php  $_result=M("Article")->field("title,url,createtime")->where(" 1  and lang=1 and website=1 AND status=1  AND catid=30")->order("listorder = 0,listorder asc,id desc")->limit("10")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li>
                                        <a href="<?php echo ($r["url"]); ?>" target="_blank" class="tt"><?php echo ($r["title"]); ?></a>
                                        <div class="n-info">
                                            <span class="time"><?php echo (todate($r["createtime"],'Y-m-d H:i')); ?></span>
                                        </div>
