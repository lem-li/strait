...
<section id="page-content">
    <div class="row page-sub-content">
        ...
        <article id="right" class="main-content" style="margin-left: -210px">
            <!-- =========修改添加样式 -->
            <div id="main-content">
                <div class="cm">
                ...
                <div style="padding-bottom: 20px; height: 30px; color: rgb(102, 102, 102);">您输入的检索词：<font style="color:red;"><?php echo ($keyword); ?></font>，共查到<font style="color:red;"><?php echo ($count); ?></font>篇相关网页
                </div>
                    <!-- 内容 -->
