...
<div class="wrap" style="overflow:hidden;">
    ...
    <div class="list_r">
        ...
        <ul class="news_list">
            <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li><a href="__ROOT__/index.php?m=<?php echo ($module_name); ?>&a=show&id=<?php echo ($vo["id"]); if($l=='en') : ?>&l=en<?php endif;?>" title="<?php echo ($vo["title"]); ?>">> <?php echo (str_cut($vo["title"],90)); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
