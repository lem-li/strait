...
<div class="wrap" id="guanlian">
    ...
    <div class="friendlink_b" style="margin: 80px 0 -47px;">
        <?php  $_result=M("Link")->field("*")->where(" status = 1  and lang=1 and typeid=2 and  linktype=1")->order("listorder asc")->limit("100")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><a href="<?php echo ($r['siteurl']); ?>" target="_blank" title="<?php echo ($r['name']); ?>" style="width: 19%;height:45px;line-height:17px;padding-right:10px;"><?php echo ($r['name']); ?></a><?php endforeach; endif;?>
    </div>
    <div class="friendlink_t">
        <ul>
            <?php  $_result=M("Link")->field("*")->where(" status = 1  and lang=1 and typeid=2 and  linktype=2")->order("listorder asc")->limit("100")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li>
...
<div class="wrap" id="hezuo">
    ...
    <div class="friendlink_b" style="margin: 80px 0 -47px;">
        <?php  $_result=M("Link")->field("*")->where(" status = 1  and lang=1 and typeid=3 and  linktype=1")->order("listorder asc")->limit("100")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><a href="<?php echo ($r['siteurl']); ?>" target="_blank" title="<?php echo ($r['name']); ?>" style="width: 19%;height:45px;line-height:17px;padding-right:10px;"><?php echo ($r['name']); ?></a><?php endforeach; endif;?>
    </div>
    <div class="friendlink_t">
        <ul>
            <?php  $_result=M("Link")->field("*")->where(" status = 1  and lang=1 and typeid=3 and  linktype=2")->order("listorder asc")->limit("100")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li>
                    <a href="<?php echo ($r['siteurl']); ?>" target="_blank" title="<?php echo ($r['name']); ?>">
                        <img width="150px" height="80px" src="<?php echo ($r['logo']); ?>">
                        <span><?php echo ($r['name']); ?></span>
                    </a>
...
<div class="wrap" id="changyong">
    ...
    <div class="friendlink_b" style="margin: 80px 0 -47px;">
        <?php  $_result=M("Link")->field("*")->where(" status = 1  and lang=1 and typeid=8 and  linktype=1")->order("listorder asc")->limit("100")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><a href="<?php echo ($r['siteurl']); ?>" target="_blank" title="<?php echo ($r['name']); ?>" style="width: 19%;height:45px;line-height:17px;padding-right:10px;"><?php echo ($r['name']); ?></a><?php endforeach; endif;?>
    </div>
    <div class="friendlink_t">
        <ul>
            <?php  $_result=M("Link")->field("*")->where(" status = 1  and lang=1 and typeid=8 and  linktype=2")->order("listorder asc")->limit("100")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li>
                    <a href="<?php echo ($r['siteurl']); ?>" target="_blank" title="<?php echo ($r['name']); ?>">
                        <img width="150px" height="80px" src="<?php echo ($r['logo']); ?>">
                        <span><?php echo ($r['name']); ?></span>
                    </a>
