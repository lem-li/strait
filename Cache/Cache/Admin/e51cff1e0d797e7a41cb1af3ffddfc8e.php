...
<table cellpadding=0 cellspacing=0 class="table_form" width="100%">
		...
		<td>
		<select name="website">
		<?php if(is_array($website)): $i = 0; $__LIST__ = $website;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row['id']); ?>" <?php if(($webid) == $row['id']): ?>selected="selected"<?php endif; if(($vo['website']) == $row['id']): ?>selected="selected"<?php endif; ?>><?php echo ($row['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		</select>
		</td>
		</tr>
                <?php else: ?>
...
<?php if($view_id!=''): ?><input TYPE="hidden" name="id" value="<?php echo ($view_id); ?>"><?php endif; ?>
