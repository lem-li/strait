...
<table cellpadding=0 cellspacing=0 class="table_form" width="100%">
	<tr>
		  <td width="120"><font color="red">*</font><?php echo L(LANG_NAME);?></td>
	...
	<tr>
		  <td width="120"><font color="red">*</font><?php echo L(LANG_MARK);?></td>
		  <td><input type="text" id="mark" name="mark" value="<?php echo ($vo["mark"]); ?>" class="input-text"  validate="required:true,en_num:true, minlength:2, maxlength:20"/> </td>
	</tr>
	<tr>
		  <td><?php echo L(LANG_FLAG);?></td>
		  <td><input type="text" id="flag" name="flag" value="<?php echo ($vo["flag"]); ?>" class="input-text"/></td>
	</tr>
	<!--
	<tr>
		  <td><?php echo L(LANG_PATH);?></td>
		  <td><input type="text" id="path" name="path" value="<?php echo ($vo["path"]); ?>" class="input-text"/></td>
	</tr>
	<tr>
		  <td><?php echo L(LANG_DOMAIN);?></td>
		  <td><input type="text" id="domain" name="domain" value="<?php echo ($vo["domain"]); ?>" class="input-text"/></td>
	</tr>
	-->

	<tr>
		  <td><?php echo L(STATUS);?></td>
		  <td><?php echo Form::radio(array('field'=>'status','options'=>array('1'=>L('yes'),'0'=>L('no'))),$vo['status']);?></td>
	</tr>
