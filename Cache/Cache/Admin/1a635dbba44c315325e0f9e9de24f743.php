...
<div id="header" class="header">
	<div class="logo"><!--a href="" target="_blank"><img src="./Public/Images/admin_logo.gif" width="180"></a--></div>
	<div class="nav f_r"> <a href="javascript:void(0);" onclick="gocacheurl();"><?php echo L('UPDATE_CACHE');?></a> 
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
...
<!--div id="footer" class="footer" >Powered by <a href="" target="_blank">YourPHP</a>&nbsp;<?php echo VERSION;?>&nbsp;<?php echo UPDATETIME;?> Copyright 2008-2011 <span id="run"></span></div-->
